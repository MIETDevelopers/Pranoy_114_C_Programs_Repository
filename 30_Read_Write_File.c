...
{	//start of structure body
 ...
 {	//start of main body
	...
	fptr=fopen("D:\\Pranoy_114_C_Programs_Repository\\Read_Write_File.txt","wb"); //Opening the file from the location.
	...
	fclose(fptr);
	fptr=fopen("D:\\Pranoy_114_C_Programs_Repository\\Read_Write_File.txt","rb");
