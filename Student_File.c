...
{	//start of main function body
	...
	fptr=fopen("D:\\Pranoy_114_C_Programs_Repository\\Reading_writing_Studentmark_File.txt","wb"); //Opening the file from the location.
	for (i=0;i<1;++i) 
	{//start of loop body
		fflush(stdin);
	...
	fclose(fptr);
	fptr=fopen("D:\\Pranoy_114_C_Programs_Repository\\Reading_writing_Studentmark_File.txt","rb");
